...
def criar_personagem():
    ...
    for i, v in enumerate(vocacoes):
        print(
            f"{i+1} - {v}: Poder: {VOCACOES_FAROESTE[v]["poder"]}, Defesa: {VOCACOES_FAROESTE[v]["defesa"]}, Vida: {VOCACOES_FAROESTE[v]["vida"]}, Munição: {VOCACOES_FAROESTE[v]["muniçao"]}, Item: {VOCACOES_FAROESTE[v]["item"]}")

...
class Combate:
    ...
    def iniciar_combate(self):
        ...
        while self.jogador.vida_atual > 0 and self.inimigo.vida_atual > 0:
            ...
            print(f"{self.inimigo.nome} [HP: {self.inimigo.vida_atual}/{self.inimigo.vida_maxima}]")
            ...
            if escolha == "1":
                if self.jogador.muniçao > 0:
                    ...
                    if dano > 0:
                        print(f"Você acertou o {self.inimigo.nome} e causou {dano} de dano!")
                ...
                print(f"Você se prepara para o impacto. Defesa aumentada em {defesa_bonus_jogador} para este turno.")
            ...
            dano_inimigo = self.calcular_dano(self.inimigo, self.jogador, defesa_bonus_jogador)
            if dano_inimigo > 0:
                print(f"O {self.inimigo.nome} te atacou e causou {dano_inimigo} de dano!")
    ...
    def calcular_dano(self, atacante, defensor, bonus_defesa=0):
        ...
        if rolagem >= defensor.esquiva:
            ...
            return max(1, dano_final) # No mínimo 1 de dano se acertar
        return 0 # Errou
